...
ibm_db_conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=30756;SECURITY=SSL;SSLServerCertificateDigiCertGlobalRootCA.crt;PROTOCOL=TCPIP;UID=jgv11848;PWD=tf4g7EltzuerAS7Z;","","")
                                            


# app.config['DB2_DRIVER'] = '{IBM DB2 ODBC DRIVER}'pip install --upgrade pip
...
#         try:
#             print("Break point3")
#             connectionID = ibm_db_dbi.connect("database=bludb;hostname=2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;port=30756;protocol=tcpip;uid=jgv11848;pwd=tf4g7EltzuerAS7Z;security=SSL;", '', '')
